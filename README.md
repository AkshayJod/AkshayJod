...
<p align="center">
  ...
  Building tools that make learning hands-on and accessible.
</p>
...
- **[Ablox](https://ablox.ableducation.com)** — A web-based block-coding & robotics platform for students. Think Scratch meets real hardware (Arduino, ESP32, and more), all in the browser via Web Serial API.
- **Kreativity League** — An EdTech competition platform for STEM events — Robotics, CodeQuest, STEMpreneur, and beyond.
...
- WebAssembly-based Arduino simulation (AVR8js)
- Web Serial API for browser ↔ hardware communication
